...
.loading {
    ...
    .plyr__video-wrapper::before {
        ...
        height: 35px;
        width: 35px;
        background: url('https://w7.pngwing.com/pngs/74/390/png-transparent-mashed-potato-french-fries-potato-wedges-baked-potato-potato-chip-vegetable-food-baking-tomato-thumbnail.png') no-repeat;
...
<div class="loading-text">
    <span class="loading-text-words" style="color:#d9230f;">P</span>
